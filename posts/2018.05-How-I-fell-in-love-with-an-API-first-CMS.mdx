...
I remember first wanting to create a theme for Wordpress. So I went to Google, searched for tutorials and articles — and ended up with tons of walkthroughs on how to update some CSS to “_theme_” your Wordpress site with a custom color. Or behold, add some padding — tutorials praised this as the high arts. **That wasn’t what I wanted! That wasn’t what I wanted at all!**
...
> _There was just no satisfactory documentation on how to get all the data_
...
> _Separating the concerns of content management and content presentation will save your developers heaps of time_
...
_Originally published at [www.contentful.com](https://www.contentful.com/blog/2018/05/02/how-i-fell-in-love-with-an-api-first-cms/) on May 2, 2018._
