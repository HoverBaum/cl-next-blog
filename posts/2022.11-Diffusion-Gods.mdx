...
![The Pantheon of Diffusion](/images/general/gods-of-diffusion/gods_of_diffusion.png)
...
As you can see above the pairs of gods always share the same seed for generation. This gives them a style that is somewhat related. The part of the prompt that gives the overall "style" was inspired by Concept Art images on [Lexica](https://lexica.art/) that I likes and combined.
