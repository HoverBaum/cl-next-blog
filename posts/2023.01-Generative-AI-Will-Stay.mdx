...
**Text-to-Image AIs** like Stable-Diffusion, [#Midjourney](https://www.linkedin.com/feed/hashtag/midjourney), or Dall-E went from blurry images in which you could make out shapes to producing high-quality results. While Dall-E is best known in the press, Midjourney produces the best results as of today with the open-source alternative of Stable-Diffusion quickly catching up.
...
**Text generation AIs** like [#ChatGPT](https://www.linkedin.com/feed/hashtag/chatgpt) or Copilot also made tremendous progress in 2022. They went from testing things out to being super useful in production.
